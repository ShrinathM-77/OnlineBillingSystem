...
root.title("Welcome to Radhesham Hotel")
...
title_label = Label(title_frame, text="Radhesham Hotel", 
...
#===============Menu===============
menu_frame = Frame(root,bd=8, bg="red", relief=GROOVE)
menu_frame.place(x=0,y=125,height=585,width=680)

menu_label = Label(menu_frame, text="Menu", 
                    font=("times new roman", 20, "bold"),bg = "Olive", fg="black", pady=0)
...
#===============Item Frame=============
item_frame = Frame(root,bd=8, bg="red", relief=GROOVE)
item_frame.place(x=680,y=125,height=230,width=680)

item_title_label = Label(item_frame, text="Item", 
                    font=("times new roman", 20, "bold"),bg = "Olive", fg="black")
...
#==============Order Frame=====================================================
order_frame = Frame(root,bd=8, bg="red", relief=GROOVE)
...
#=====This Project Is Devloped && Maitained By Shrinath U Mate=======#